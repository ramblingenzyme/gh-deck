...
export const MOCK_PRS: PRItem[] = [
  ...
  },
  {
    type: "pr",
    id: 6,
    title: "feat: add OAuth2 PKCE flow for CLI auth",
    repo: "acme/cli",
    author: "nadia_s",
    assignee: null,
    number: 302,
    reviews: { approved: 2, requested: 0 },
    comments: 5,
    status: "merged",
    age: d(2),
    labels: [{ name: "enhancement", color: "0075ca" }],
    url: "https://github.com/acme/cli/pull/302",
  },
  {
    type: "pr",
    id: 7,
    title: "fix: revert broken cache invalidation logic",
    repo: "acme/worker",
    author: "themarcus",
    assignee: null,
    number: 235,
    ...
    url: "https://github.com/acme/worker/pull/235",
  },
];
